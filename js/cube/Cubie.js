...
class Cubie {
    constructor(x, y, z) {
        ...
        if (x === -1) {
            this.faces.push(
                new Face(x, y, z, new THREE.Vector3(-1, 0, 0), 0x00ff00)
            );
        } else if (x === 1) {
            this.faces.push(
                new Face(x, y, z, new THREE.Vector3(1, 0, 0), 0x0000ff)
            );
        }
        if (y === -1) {
            this.faces.push(
                new Face(x, y, z, new THREE.Vector3(0, -1, 0), 0xffff00)
            );
        } else if (y === 1) {
            this.faces.push(
                new Face(x, y, z, new THREE.Vector3(0, 1, 0), 0xffffff)
            );
        }
        if (z === -1) {
            this.faces.push(
                new Face(x, y, z, new THREE.Vector3(0, 0, -1), 0xff9900)
            );
        } else if (z === 1) {
            this.faces.push(
                new Face(x, y, z, new THREE.Vector3(0, 0, 1), 0xff0000)
            );
        }
